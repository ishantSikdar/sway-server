...
const { API_URI_SIGNUP, API_URI_SIGNIN, API_URI_USER_DETAILS, API_URI_USER_PHOTO, API_URI_USER_BANNER, API_URI_PUBLIC_USER_DETAILS } = require('../constant/endpoints');
const { signupRoute, signinRoute, userDetailsRoute, editUserDetailsRoute, editUserProfilePictureRoute, editUserBannerPictureRoute, getPublicUserDetailsRoute } = require("../controller/userController");
...
router.get(API_URI_PUBLIC_USER_DETAILS, getPublicUserDetailsRoute);

const { createCommunity, joinCommunity, generateInviteCode, fetchAllJoinedCommunities, fetchCommunityDetails, fetchCommunityMembers } = require("../service/communityServices");

...
const { signupRoute, signinRoute, homeRoute, userDetailsRoute, editUserDetailsRoute } = require("../controller/userController");
...
router.put(API_URI_USER_DETAILS, userAuthMiddleware, editUserDetailsRoute);
